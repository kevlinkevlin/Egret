window.skins={};
	...
	var DialogOk$Skin1 = 	(function (_super) {
		...
		function DialogOk$Skin1() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","dialog_zhunbei_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	function SlotViewSkin() {
		_super.call(this);
		this.skinParts = ["kake1","slotstart","startgroup","stop_over","stop_up","stopgroup","back_btn"];
		
		this.height = 768;
		this.width = 1024;
		this.elementsContent = [this._Image1_i(),this.kake1_i(),this.startgroup_i(),this.stopgroup_i(),this.back_btn_i()];
	}
