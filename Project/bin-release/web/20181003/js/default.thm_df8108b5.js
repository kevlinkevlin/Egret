window.skins={};
	...
	function DialogOk() {
		_super.call(this);
		this.skinParts = ["dialog_box","dialog_name","lb_dialog_text","char_name","img_dialog_outer","ready_btn","back_btn"];
		
		this.height = 768;
		this.width = 1024;
		this.elementsContent = [this.dialog_box_i(),this.dialog_name_i(),this.lb_dialog_text_i(),this.char_name_i(),this.img_dialog_outer_i(),this.ready_btn_i(),this.back_btn_i()];
	}
