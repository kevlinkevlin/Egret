window.skins={};
	...
	function DialogOk() {
		_super.call(this);
		this.skinParts = ["img_dialog_outer","dialog_box","lb_dialog_text","diagroup","dialog_name","char_name","namegroup","img_dialog_outer2","back_btn","ready_btn"];
		
		this.height = 320;
		this.width = 420;
		this.elementsContent = [this.img_dialog_outer_i(),this.diagroup_i(),this.namegroup_i(),this.img_dialog_outer2_i(),this.back_btn_i(),this.ready_btn_i()];
	}
	...
	_proto.diagroup_i = function () {
		...
		t.right = 0;
		t.y = 241;
		t.elementsContent = [this.dialog_box_i(),this.lb_dialog_text_i()];
		return t;
	};
	...
	_proto.namegroup_i = function () {
		...
		t.x = 15;
		t.y = 210;
		t.elementsContent = [this.dialog_name_i(),this.char_name_i()];
		return t;
	};
	_proto.dialog_name_i = function () {
		...
		t.source = "box_btn_png";
		t.width = 146.89;
		t.x = 1.3900000000000006;
		t.y = 0.8499999999999943;
		return t;
	};
	_proto.char_name_i = function () {
		...
		t.verticalAlign = "middle";
		t.width = 146.32;
		t.x = 1.9600000000000009;
		t.y = 1.2199999999999989;
		return t;
	};
	_proto.img_dialog_outer2_i = function () {
		var t = new eui.Image();
		this.img_dialog_outer2 = t;
		t.alpha = 0;
		t.anchorOffsetX = 0;
		t.bottom = 0;
		t.fillMode = "scale";
	...
	function SlotViewSkin() {
		_super.call(this);
		this.skinParts = ["kake1","slotstart","startgroup","stop_over","stop_up","back_btn","stopgroup"];
		
		this.height = 320;
		this.width = 420;
		this.elementsContent = [this._Image1_i(),this.kake1_i(),this.startgroup_i(),this.stopgroup_i()];
	}
	...
	_proto.stopgroup_i = function () {
		...
		t.width = 50;
		t.y = 206.83;
		t.elementsContent = [this.stop_over_i(),this.stop_up_i(),this.back_btn_i()];
		return t;
	};
