window.skins={};
	...
	var DialogOk$Skin2 = 	(function (_super) {
		...
		function DialogOk$Skin2() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","button02_light_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	_proto.diagroup_i = function () {
		...
		t.right = 0;
		t.y = 241;
		t.elementsContent = [this.dialog_box_i(),this.lb_dialog_text_i(),this.back_btn_i()];
		return t;
	};
	...
	function SlotViewSkin() {
		_super.call(this);
		this.skinParts = ["a","close_scene","kake1","slotstart","startgroup","stop_over","stop_up","back_btn","stopgroup"];
		
		this.height = 320;
		this.width = 420;
		this.a_i();
		this.elementsContent = [this._Image1_i(),this.close_scene_i(),this.kake1_i(),this.startgroup_i(),this.stopgroup_i()];
		
		eui.Binding.$bindProperties(this, ["stopgroup"],[0],this._TweenItem1,"target");
		eui.Binding.$bindProperties(this, ["stop_up"],[0],this._TweenItem2,"target");
	}
