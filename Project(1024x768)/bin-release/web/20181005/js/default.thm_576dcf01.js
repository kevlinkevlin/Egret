window.skins={};
	...
	function DialogOk() {
		_super.call(this);
		this.skinParts = ["img_dialog_outer","dialog_box","lb_dialog_text","diagroup","dialog_name","char_name","namegroup","img_dialog_outer2","ready_btn","back_btn"];
		
		this.height = 768;
		this.width = 1024;
		this.elementsContent = [this.img_dialog_outer_i(),this.diagroup_i(),this.namegroup_i(),this.img_dialog_outer2_i(),this.ready_btn_i(),this.back_btn_i()];
	}
	...
	_proto.char_name_i = function () {
		...
		t.verticalAlign = "middle";
		t.width = 412.32;
		t.x = -6.160000000000004;
		t.y = 1.740000000000009;
		return t;
	};
