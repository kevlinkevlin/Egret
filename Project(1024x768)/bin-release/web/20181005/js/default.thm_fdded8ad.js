window.skins={};
	...
	function DialogOk() {
		_super.call(this);
		this.skinParts = ["img_dialog_outer","img_dialog_outer2","dialog_box","lb_dialog_text","dialog_name","char_name","ready_btn","back_btn"];
		
		this.height = 768;
		this.width = 1024;
		this.elementsContent = [this.img_dialog_outer_i(),this.img_dialog_outer2_i(),this._Group1_i(),this._Group2_i(),this.ready_btn_i(),this.back_btn_i()];
	}
